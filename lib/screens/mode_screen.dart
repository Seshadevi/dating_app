...
@override
  ...
  Widget _buildModeOption(Data mode) {
    final isSelected = selectedMode?.id == mode.id;
    final textColor = isSelected ? DatingColors.brown : DatingColors.black;
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: isSelected
      ? LinearGradient(
          colors: [DatingColors.everqpidColor, DatingColors.lightpinks],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        )
      : LinearGradient(
          ...
          border: Border.all(
            width: 2,
            color: isSelected ? DatingColors.lightpink : DatingColors.everqpidColor,
          ),
        ),
        padding: const EdgeInsets.symmetric(horizontal: 24),
        child: Column(
  ...
  String getModeDescription(int? mode) {
    switch (mode) {
      case 4:
        return "Ready to steal fries and maybe your heart? Let’s go on sweet adventures, share sunsets, and find little moments that make love,feel,magical";
      case 5:
        return "Looking for a buddy to laugh with at 2am or dive headfirst into spontaneous plans—let’s be friends who turn ordinary days into fun memories";
      case 6:
        return "Dream big, cheer louder! Join a friendly crew of achievers who help each other shine and swap career tips (with bonus coffee runs included)";
      default:
        return "Explore this mode";
    }
  }
