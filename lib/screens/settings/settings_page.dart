  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _greenButtonTile("Add Your Email",
            ...
            const SizedBox(height: 8),
            Text(
                'Hide Your Profile Temporarily, in All Modes You Won’t Loss Any Connections And Chats'),
            const SizedBox(height: 16),
            _tileWithSwitch("Incognito Mode For Date", false),
            const SizedBox(height: 8),
            Text(
                'Only People You’ve Swiped Raight on Already Or Swipe Right On Later Will See You Profile .If You Turn On Incognito Mode For Date THis Won’t Apply Bizz or BFF  '),
            const SizedBox(height: 16),
            _tileWithSwitch("Auto - Spotlight", false),
            const SizedBox(height: 8),
            Text(
                'We’ll Use Spotlight Automatically TO Boost Your Profile When Most People See It.'),
            const SizedBox(height: 16),
            Text('Location'),
            const SizedBox(height: 16),
