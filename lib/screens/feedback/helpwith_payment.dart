...
class HelpwithPayment extends StatefulWidget {
  const HelpwithPayment({super.key});

  @override
  State<HelpwithPayment> createState() => HelpwithPaymentSate();
}

class HelpwithPaymentSate extends State<HelpwithPayment> {
