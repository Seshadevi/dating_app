...
class SuperSwipesScreen extends ConsumerStatefulWidget {
  final int typeId;
  const SuperSwipesScreen({super.key, required this.typeId});

  @override
  ConsumerState<SuperSwipesScreen> createState() => _SuperSwipesScreenState();
}

class _SuperSwipesScreenState extends ConsumerState<SuperSwipesScreen> {
  int selectedIndex = 0;
