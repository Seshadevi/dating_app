    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        try {
          ...
          state = usersData; // ✅ Update provider state here
          

       // After successful login
        // final prefs = await SharedPreferences.ge/tInstance();
...
final peoplesProvider = StateNotifierProvider<PeoplesAllProvider, PeoplesAllModel>((ref) {
